        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Expédition</h3>
                </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">expedition list</h4>
                                <!-- <h6 class="card-subtitle">Export data to Copy, CSV, Excel, PDF & Print</h6> -->
                                <div class="table-responsive m-t-10">
                                    <?php
                                        $tab_exp_app[] = array();
                                        $tab_exp_app = getexpApp();
                                    ?>
                                    <table id="example24" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <?php
                                                for($i=0; $i<count($tab_exp_app); $i++){
                                                    echo'
                                                        <tr>
                                                            
                                                            <td>'.$tab_exp_app[$i]['id_exp'].'</td>
                                                            <td>'.$tab_exp_app[$i]['nom'].'</td>
                                                            <td>'.$tab_exp_app[$i]['tel'].'</td>
                                                            <td>'.$tab_exp_app[$i]['nbr_colis'].'</td>
                                                           
                                                            <td>'.$tab_exp_app[$i]['date_ramassage'].'</td>
                                                            <td>'.$tab_exp_app[$i]['heure_ramassage'].'</td>
                                                             <td>'.$tab_exp_app[$i]['adresse_rammassage'].'</td>
                                                              <td>'.$tab_exp_app[$i]['adresse_livraison'].'</td>
                                                               <td>'.$tab_exp_app[$i]['date_heure'].'</td>
                                                           
                                                        </tr>
                                                    ';
                                                    //<td>'.($i+1).'</td> <a href="query/action.php?id_user_app='.$tab_exp_app[$i]['id'].'" class="btn btn-danger btn-sm" data-toggle="tooltip" data-original-title="Delete"> <i class="fa fa-trash"></i> </a>
                                                    // <a href="query/action.php?id_user_app_desactiver='.$tab_exp_app[$i]['id'].'" class="btn btn-inverse btn-sm" data-toggle="tooltip" data-original-title="Disable"> <i class="fa fa-close"></i> </a>
